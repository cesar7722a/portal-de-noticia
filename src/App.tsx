        ...
        <div className="space-y-6 pb-6">
          ...
          <div className="flex gap-4">
            <div className="w-[292px] space-y-2">
              ...
              <Text>
                Protótipo de veículo voador é<br /> apresentado, marcando o
                início da
                <br />
            ...
            <div className="w-[392px] space-y-2">
              ...
              <Text>
                ...
                <br /> hologramas, tornando as chamadas virtuais mais realistas
                e envolventes.
              </Text>
            </div>
            <div className="w-[392px] space-y-2">
              ...
              <Text>
                ...
                <br /> gráficos ultra-realistas e experiências de jogo
